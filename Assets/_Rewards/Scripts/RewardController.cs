...
namespace Rewards
{
    internal class RewardController
    {
        ...
        public RewardController(RewardView view) => _view = view;
        ...
        private void StartRewardsUpdating() => _coroutine = _view.StartCoroutine(RewardsStateUpdater());
        ...
        private string GetTimerNewRewardText()
        {
            ...
            if (_view.TimeGetReward.HasValue)
            {
                ...
                string timeGetReward =
                    $"{currentClaimCooldown.Days:D2} days and {currentClaimCooldown.Hours:D2}:" +
                    $"{currentClaimCooldown.Minutes:D2}:{currentClaimCooldown.Seconds:D2} hours.";

                return $"Until the next award {timeGetReward}";
            }
        ...
        private void RefreshSlots()
        {
            for (var i = 0; i < _slots.Count; i++)
            {
                ...
                _slots[i].SetData(reward, countPeriod, isSelected, _view.CurrentAwardPeriod);
            }
        }
    }
}
