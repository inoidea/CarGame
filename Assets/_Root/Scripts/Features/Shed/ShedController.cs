...
namespace Features.Shed
{
    ...
    internal class ShedController : BaseController, IShedController
    {
        ...
        private void Apply()
        {
            ...
            Log($"Apply. Current Speed: {_profilePlayer.CurrentCar.Speed}, JumpHeight: {_profilePlayer.CurrentCar.JumpHeight}");
        }
        ...
        private void Back()
        {
            ...
            Log($"Back. Current Speed: {_profilePlayer.CurrentCar.Speed}, JumpHeight: {_profilePlayer.CurrentCar.JumpHeight}");
        }
