...
internal abstract class ParentObject : IDisposable
{
    ...
    protected void AddContext(BaseContext context) => AddDisposableObject(context);
    ...
    protected void Log(string message) => Debug.Log(WrapMessage(message));
    protected void Error(string message) => Debug.LogError(WrapMessage(message));
